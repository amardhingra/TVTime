...
public class Strings {
	...
	public final static String IS_RUNNING = "is_running";
	public final static String NUMBER_OF_SHOWS = "number_of_shows";
	public final static String BACKGROUND_CAL_ID = "back_cal_id";
